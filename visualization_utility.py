...
def visualize_element_changes(page, element):
    ...
    while True:
        ...
        # Filter for only clickable new elements
        ...
        if new_elements:
            ...
            # Allow user to click a new element
            try:
                choice = input(
                ...
                element_index = int(choice) - 1  # Convert to 0-based index
        ...
        # Show style changes
        print("\nStyle Changes:")
        compare_styles(initial_state['targetElement']['computedStyle'],
                       post_state['targetElement']['computedStyle'])

        # Show ARIA changes
        print("\nARIA Attribute Changes:")
        compare_aria(initial_state['targetElement']['ariaAttributes'],
                     post_state['targetElement']['ariaAttributes'])

        print("\n=== Element Visualization End ===")
        break  # Exit if no elements to click or after click attempt
...
def main():
    try:
        ...
        time.sleep(5)  # Wait for pages to load
